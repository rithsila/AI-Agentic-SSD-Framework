...
3. Verify the task is genuinely complete:
...
4. If any criterion fails, STOP and report what's missing. Do NOT mark done.
5. If `/verify` passed and all criteria pass, edit `ImplementPlan.md`:
